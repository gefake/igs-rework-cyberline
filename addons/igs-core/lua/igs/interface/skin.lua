...
IGS.S.COLORS = {
	...
	PASSIVE_SELECTIONS  = Color(84, 73, 102), -- Фон панели тегов, цвет кнопки с балансом, верхушки таблиц, не выделенные кнопки https://img.qweqwe.ovh/1509370720597.png
	INNER_SELECTIONS    = Color(55, 51, 61), -- Фон иконок на плашках, фон панелек последних покупок... https://img.qweqwe.ovh/1509370766148.png

	SOFT_LINE           = Color(139, 111, 146, 201), -- Линия между секциями, типа "Информация" и "Описание" в инфе об итеме
	HARD_LINE           = Color(97, 79, 114, 201), -- Обводки панелей

	HIGHLIGHTING        = Color(229, 163, 255, 201),   -- Обводка кнопок, цвет текста не активной кнопки
	HIGHLIGHT_INACTIVE  = Color(180, 156, 202, 201), -- Цвет иконки неактивной кнопки таббара, мигающая иконка на фрейме помощи https://img.qweqwe.ovh/1509371884592.png

	TEXT_HARD           = Color(218,211,211),       -- Заголовки, выделяющиеся тексты https://img.qweqwe.ovh/1509372019687.png
	TEXT_SOFT           = Color(140,140,150), -- Описания, значения чего-то
	TEXT_ON_HIGHLIGHT   = Color(55, 51, 61), -- Цвет текста на выделенных кнопках
	...
	LOG_NORMAL          = Color(218,211,211),       -- В логах пополнения обычные записи

	ICON                = Color(55, 51, 61), -- цвет иконок на плашечках
}
