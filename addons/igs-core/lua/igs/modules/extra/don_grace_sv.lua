...
IGS.C.TopDon_TextRecord   = "$nick побил рекорд доната в этом месяце, пополнив счет на $sum эфир.\nПредыдущий рекорд установил $nick_prev, пополнив счет на $sum_prev эфир"
